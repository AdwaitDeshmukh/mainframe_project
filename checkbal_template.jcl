...
//DBRMLIB  DD DSN=Z76164.DBRMLIB(CHKBAL),DISP=OLD
//SYSIN    DD *
      ...
      * HOST VARIABLES
       ...
       01 WS-DISP-BAL     PIC ZZZ,ZZZ,ZZ9.99.
      ...
      *--------------------------------------------
           EXEC SQL
               SELECT FNAME, LNAME INTO :WS-FNAME, :WS-LNAME
               FROM Z76164.USERS
      ...
      *--------------------------------------------
           ...
           IF SQLCODE = 100
               DISPLAY 'WALLET NOT FOUND FOR: ' WS-ACCT-NUM
               STOP RUN
           END-IF

           IF SQLCODE NOT = 0
               DISPLAY 'ERROR FETCHING BALANCE SQLCODE: ' SQLCODE
               STOP RUN
           END-IF
      ...
      *--------------------------------------------
           MOVE WS-BALANCE TO WS-DISP-BAL
           DISPLAY '================================'
...
//SYSLMOD  DD DSN=Z76164.MFLNC.LOAD(CHKBAL),DISP=SHR
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
...
//SYSTSIN  DD *
 DSN SYSTEM(DBDG)
 BIND PLAN(Z76164) MEMBER(CHKBAL) LIB('Z76164.DBRMLIB') -
...
//SYSTSIN  DD *
 DSN SYSTEM(DBDG)
 RUN PROGRAM(CHKBAL) PLAN(Z76164) LIB('Z76164.MFLNC.LOAD')
 END
/*
//SYSUDUMP DD SYSOUT=*
//SYSTSPRT DD SYSOUT=*
